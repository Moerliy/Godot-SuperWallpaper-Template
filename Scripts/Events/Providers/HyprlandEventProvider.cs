...
namespace hyprlandsuperwallpapertemplate.Scripts.Events.Providers
{
    public class HyprlandEventProvider : IEventProvider
    {
        // Now computed at runtime from the official Hyprland IPC spec:
        ...
        public HyprlandEventProvider()
        {
            ...
            GD.Print($"HyprlandEventProvider: Constructors initialized");
        }
